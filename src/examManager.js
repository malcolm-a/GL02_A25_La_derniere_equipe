...
export function verifExam(exam){
    ...
    if(nbQuestion<15){
        erreurs.push(`Nombre insuffisant de questions : ${nbQuestion} (minimum requis : 15).`);
    ...
    const typesValides = ["multiple_choice","true_false", "numeric", "short_answer", "matching", "essay", "description"];
